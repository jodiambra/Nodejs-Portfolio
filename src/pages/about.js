...
import profilePic from "../../public/images/profile/headshot 7.jpg";
      ...
      <main className="flex w-full flex-col items-center justify-center dark:text-light">
        <Layout className="pt-16">
          <AnimatedText
            ...
            className="mb-16 !leading-tight lg:!text-3xl sm:!text-6xl xs:!text-4xl sm:mb-8"
          />
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8">
              ...
              <p className="my-4 font-medium">
                Prior to becoming a data scientist, I worked as a QC Analyst at Arxada, where I analyzed chemical, raw materials,
                and in-process materials to support compliance with company standards. I was also a Research Associate at RCUOG,
                where I contributed to leading-edge Areca nut carcinogenicity data and presented my findings at conferences. In addition,
                I worked as a Research Lab Assistant at the University of Pittsburgh, where I conducted experiments
                with fruit fly (drosophila) DNA.
              </p>
